...
class FooodImageView: UIImageView {
...
class Venue_Cell: UICollectionViewCell {
    ...
    let foodImage = FooodImageView(image: #imageLiteral(resourceName: "hot-coffee-rounded-cup-on-a-plate-from-side-view"))
